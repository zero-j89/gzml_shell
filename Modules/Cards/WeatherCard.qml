...
NBox {
  ...
  readonly property bool isCloudy: testEffects === "cloud" || (testEffects === "" && isDayTime && !isRaining && !isSnowing && !isFoggy && (currentWeatherCode === 1 || currentWeatherCode === 2 || currentWeatherCode === 3))
