        ...
        WlSessionLockSurface {
          ...
          Component {
            ...
            Item {
              ...
              // GZML Shell background video.
              // Put the enfield video at:
              // ~/.config/quickshell-noctalia/Modules/LockScreen/background/bg.mp4
              Rectangle {
                anchors.fill: parent
                color: "#05070d"
              }
              ...
              MediaPlayer {
                id: gzmlBackgroundPlayer
                source: Qt.resolvedUrl("background/bg.mp4")
                autoPlay: true
                loops: MediaPlayer.Infinite
                muted: true
                videoOutput: gzmlBackgroundVideo
              }

              VideoOutput {
                id: gzmlBackgroundVideo
                anchors.fill: parent
                fillMode: VideoOutput.PreserveAspectCrop
              }

              // Soft dark overlay so text/panel remains readable.
              Rectangle {
                anchors.fill: parent
                color: "#000000"
                opacity: 0.28
              ...
              Item {
                ...
                // GZML Shell top-left clock / date.
                // This replaces the stock solid header card, keeping everything directly over the video.
                Item {
                  id: gzmlHeader
                  anchors.left: parent.left
                  anchors.top: parent.top
                  anchors.leftMargin: 64 * Style.uiScaleRatio
                  anchors.topMargin: 48 * Style.uiScaleRatio
                  ...
                  Timer {
                    ...
                    running: true
                    repeat: true
                    onTriggered: gzmlHeader.now = new Date()
                  }
                  ...
                  Column {
                    ...
                    Text {
                      text: Qt.formatTime(gzmlHeader.now, Settings.data.general.use24hClock ? "HH:mm" : "h:mm AP")
                      color: "#f8f1d6"
                      font.pixelSize: 76 * Style.uiScaleRatio
                    ...
                    Row {
                      ...
                      Text {
                        text: Qt.formatDate(gzmlHeader.now, "dddd, MMMM d").toUpperCase()
                        color: "#ffcc33"
                        opacity: 0.92
